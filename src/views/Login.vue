    ...
    <v-app id="inspire">
      ...
      <v-content>
        <v-container fluid fill-height>
          <v-layout justify-center align-center justify-space-around>
            <v-flex xs sm md4>
            ...
            <v-flex xs12 sm8 md4>
              <v-card class="elevation-12" v-if="isLoginForm">
                ...
                <v-card-text>
                  <v-form>
                    <v-text-field prepend-icon="person" v-model="loginModel.userName" name="login" label="Login"
                      type="text"></v-text-field>
                    <v-text-field prepend-icon="lock" v-model="loginModel.password" name="password" label="Password"
                      id="password" type="password" v-on:keyup.enter="userLogin()"></v-text-field>
                  </v-form>
                </v-card-text>
                <v-card-actions>
              ...
              <v-card class="elevation-12" v-if="isForgotForm">
                ...
                <v-card-text>
                  <v-form>
                    <v-text-field prepend-icon="email" v-model="userEmail" name="email" label="Email"
              ...
              <v-card class="elevation-12" v-if="isChangePasswordForm">
                ...
                <v-card-text>
                  <v-form>
                    <v-text-field prepend-icon="security" v-model="OTP" name="otp" label="OTP"
                      type="text"></v-text-field>
                    <v-text-field prepend-icon="lock" v-model="userNewPassword" name="newpassword" label="New Password"
