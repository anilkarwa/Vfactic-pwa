...
const generateSchemaForTransaction = (schemas,headerModel,detailModel,footerModel,totalModel ) => {
               ...
               disabled: (!p.readonly)? p.readonly:( (p.readOnlyCondition == "") ? p.readonly:function(model){
                    ...
                    if(readOnlyCondition != ''){
                        if (readOnlyCondition.substring(0, 1) == '#' || readOnlyCondition.substring(0, 1) == '(') {
                            var FieldData = returnFormula(readOnlyCondition,headerModel,detailModel,footerModel,totalModel).split('^');
               ...
               visible:(!p.visible)?!p.visible:( p.visibleCondition == ""? !p.visible:function(model){
                ...
                if(visibleCondition != ''){
                    if (visibleCondition.substring(0, 1) == '#' || visibleCondition.substring(0, 1) == '(') {
                        var FieldData = returnFormula(visibleCondition,headerModel,detailModel,footerModel,totalModel).split('^');
...
export default generateSchemaForTransaction;