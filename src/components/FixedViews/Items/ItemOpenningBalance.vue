  ...
  <div id="app">
    <v-app id="inspire">
      ...
      <!-- END: Code for Supplier Group Master Table data -->
                ...
                <v-flex xs12 sm12 md12>
                  <v-form ref="NewRecordForm" v-model="addFromValid"  lazy-validation>
                    <v-container fluid grid-list-xl>
                      <v-layout row >
                        <v-flex xs12 sm3 md3>
                          <v-select :rules="requiredRules"   v-model="itemOpenningData.locationId"  :items="locationData" item-text="locationCode" item-value="locationId"
                            label="Location"  required  ></v-select>
                        </v-flex>
                        <v-flex xs12 sm3 md3>
                          <v-autocomplete :rules="requiredRules"   v-model="selectedItem"  :items="searchItemResult" clearable
                        ...
                        <v-flex xs12 sm3 md3>
                          <v-text-field :rules="requiredRules"   v-model="itemUOM"  label="UOM"
                            required  ></v-text-field>
                        </v-flex>
                        <v-flex xs12 sm3 md3>
                         <v-menu  reff="datePickerModal" v-model="datePickerModal" :close-on-content-click="false" lazy transition="scale-transition" offset-y
                                ...
                                <template v-slot:activator="{ on }">
                                  <v-text-field :rules="requiredRules"  v-model="dateFormatted"  label="Date" persistent-hint prepend-icon="event"  @blur="date = parseDate(dateFormatted)"  v-on="on"   ></v-text-field>
                                </template>
                        ...
                        <v-flex xs12 sm3 md3>
                          <v-text-field :rules="requiredRules"  type="number" v-model="itemOpenningData.openningRate"  label="Rate"
                            required prefix="र"   ></v-text-field>
                        </v-flex>
                        <v-flex xs12 sm3 md3>
                          <v-text-field :rules="requiredRules"  type="text"  v-model="itemValue"  label="Value"
                            readonly prefix="र"  ></v-text-field>
                        </v-flex>
                        <v-flex xs12 sm3 md3>
                          <v-text-field   v-model="itemOpenningData.remarks"  label="Remarks"
                            required  ></v-text-field>
                        </v-flex>
       ...
       <v-snackbar
          v-model="snackbar"  :color="color"  :multi-line="true"  :timeout="timeout" :vertical="mode === 'vertical'" >{{ text }}
