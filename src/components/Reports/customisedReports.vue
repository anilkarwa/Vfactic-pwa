  ...
  <div id="app">
    <v-app id="inspire">
      ...
      <v-card>
        ...
        <v-data-table :headers="headers" :search="tableSearch" :items="customisedReportsTableData"
          ...
          <template v-slot:items="props">
            ...
            <td class="text-xs-right"><v-icon small class="mr-2"
                @click="openSelectedFile(props.item.fileName)">picture_as_pdf</v-icon></td>
          </template>
      ...
      <v-dialog v-model="pdfDailog" fullscreen hide-overlay transition="dialog-bottom-transition">
        <v-card>
          ...
          <iframe :src="selectedFilePath" height="600" width="100%" type="application/pdf" frameborder="0"></iframe>
          <!-- <pdf :src="pdf" :page="1">
