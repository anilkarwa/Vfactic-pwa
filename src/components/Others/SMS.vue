      ...
      <v-card ref="form">
        <v-card-title aria-required="TO">
              ...
              <v-list three-line>
                ...
                <v-data-table :headers="headers" :search="tableSearch" :items="partypersonalTableData"
                  ...
                  <template v-slot:items="props">
                    <td class="text-xs-right"> <v-checkbox v-model="mobileno" v-bind:value="props.item.phoneNo">
                      </v-checkbox></td>
          ...
          <v-flex xs12 sm12 md12>
            <v-text-field outline ref="mobileno" v-model="mobileno" label="Mobile Nos" prepend-inner-icon="dialpad"
              hint="(For Multiple Use of mobile numbers use Comma(,))" persistent-hint box></v-text-field>
            <!--<v-autocomplete
          label="Party Name"
          v-model="mobileno"
          :items="states"
        ...
        <v-card-title>
          <v-flex xs12 sm12 md12>
            <v-textarea outline ref="message" v-model="message" name="input-5-2"
              label="Enter Text Message.."></v-textarea>
          </v-flex>
        </v-card-title>
