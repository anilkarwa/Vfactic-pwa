...
import convertDateDetailSection from '@/DynamicProperty/convertDateDetailSection.js'
...
export default {
  ...
  methods: {
    ...
    loadPartDocTableData() {
      ...
      httpClient({
        method: 'GET',
        url: `${process.env.VUE_APP_API_BASE}StoreIndent?docID=${docID}`
      })
        .then((result) => {
    ...
    editSelectedPartyDocTranscation(params) {
      ...
      httpClient({
        method: 'GET',
        url: `${process.env.VUE_APP_API_BASE}StoreIndent?selectedID=${this.selectedID}&docID=${docID}`
      })
        .then((result) => {
          ...
          convertDateDetailSection(this.detailSectionFieldOriginalSchema, this.detailSectionData, false);
    ...
    loadSchemaForNewPartyDocTranscation() {
      ...
      httpClient({
        method: 'GET',
        url: `${process.env.VUE_APP_API_BASE}StoreIndent?docID=${docID}&type=0`
      })
        .then((result) => {
    ...
    savePartyDocHDRTableData() {
      ...
      if (this.validateStaticFields() && this.isDynamicHeaderFormValid && this.isDynamicFooterFormValid && this.isDynamicTotalFormValid && this.detailSectionData.length > 0) {
        ...
        convertDateDetailSection(this.detailSectionFieldOriginalSchema, this.detailSectionData, true);
        ...
        httpClient({
          method: 'POST',
          url: `${process.env.VUE_APP_API_BASE}StoreIndent`,
          data: updateParams
        })
          .then((result) => {
    ...
    savePartyDocDTLTableData(selectedId) {
      ...
      httpClient({
        method: 'POST',
        url: `${process.env.VUE_APP_API_BASE}StoreIndent?query=${query}`,
      })
        .then((result) => {
