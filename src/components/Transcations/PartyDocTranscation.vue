    ...
    <v-app id="inspire">
      ...
      <v-dialog v-model="pdfDailog" fullscreen hide-overlay transition="dialog-bottom-transition">
        <v-card>
          ...
          <iframe :src="pdfUrl" width="100%" height="650px" type="application/pdf"></iframe>
          <!-- <pdf :src="pdf" :page="1">
                      ...
                      <v-card-text>
                        <v-container fluid grid-list-xl>
                          <div class="actionBlock">
                              ...
                              <v-card>
                                ...
                                <v-card-text>
                                  <v-container grid-list-md>
                                    <v-layout wrap>
                                      <v-flex xs12>
                                        <v-autocomplete v-model="selectedItem" :loading="searchItemsLoading"
                                          :items="searchItemResult" clearable :search-input.sync="addSearchItems" flat
                                          hide-no-data hide-details label="Search Item" item-text="itemCode"
                                          item-value="itemId">
                            ...
                            <!-- speed dial code -->
                            <div id="create">
                              <v-speed-dial v-model="fab" top direction="right" transition="slide-x-reverse-transition">
                              ...
                              <tr :active="props.selected" @click="props.selected = !props.selected">
                                ...
                                <template v-for="header in Object.keys(detailSectionModal)">
                                  <td class="text-xs-left" :key="header"
                                    v-if="header != 'ITEMID' && header != 'UOMID' && header != 'ITEMSLNO'">{{
                            ...
                            <v-card-text>
                              <v-container grid-list-md>
                                <v-layout wrap>
                                  <v-flex xs12>
                                    <v-autocomplete v-model="selectedItem" :loading="searchItemsLoading"
                                      :items="searchItemResult" clearable :search-input.sync="searchItems" flat
                                      hide-no-data hide-details label="Search Item" item-text="itemCode"
                                      item-value="itemId">
