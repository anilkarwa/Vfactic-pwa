  ...
  <div id="app">
    <v-app id="inspire">
      <div class="text-md-center text-lg-center">
        <v-btn fab dark small color="indigo" @click="addItemInItemMaster" v-if="getCurrentUserRoles('addRight') == '1'">
            ...
            <tr>
              <td class="justify-center layout px-0">
                <v-icon v-if="getCurrentUserRoles('editRight') == '1'" small class="mr-2"
                  @click="editItemMasterData(props.item)">edit</v-icon>
...
<template slot="no-data">
                          ...
                          <v-layout row justify-space-between>
                            <v-flex xs12 sm6 md4>
                              ...
                              <b-form-input id="code" v-model="editedItems[staticFields[1]]" type="text"
                                ...
                                v-on:blur="nameBlured = true" aria-describedby="codeLiveFeedback"
                            ...
                            <v-flex xs12 sm6 md4>
                              ...
                              <b-form-select v-model="editedItems[staticFields[4]]" :options="itemGroupList"
                                ...
                                v-on:blur="itemGroupBlured = true" aria-describedby="groupIDLiveFeedback"
                            ...
                            <v-flex xs12 sm6 md4>
                              ...
                              <b-form-input id="code" v-model="editedItems[staticFields[5]]" type="text"
                                :placeholder="`Tally Alias`" />
                            </v-flex>
                            <v-flex xs12 sm6 md4>
                              <label for="">{{ `HSN Code:` }}</label>
                              <b-form-input id="code" v-model="editedItems[staticFields[6]]" type="text"
                                :placeholder="`HSN Code`" />
                            </v-flex>
                            <v-flex xs12 sm6 md4>
                              <label for="">{{ `${preFix} Type: ` }}</label><span class="mandatoryStar">*</span>
                              <b-form-input v-model="editedItems[staticFields[7]]" type="text"
                                :placeholder="`Item Type`" list="ItemTypeList"
                            ...
                            <v-flex xs12 sm6 md4>
                              ...
                              <b-form-select v-model="editedItems[staticFields[8]]" :options="UOMList"
                                ...
                                v-on:blur="UOMBlured = true" aria-describedby="UOMLiveFeedback" value-field="UOMID"
                                text-field="UOMCode" />
                            ...
                            <v-layout wrap>
                              <v-flex xs12 sm4 md4>
                                <b-form-checkbox id="BOMItemEdit" v-model="editedItems[staticFields[9]]">
                                  BOM Item ?
                                </b-form-checkbox>
                              </v-flex>
                              <v-flex xs12 sm8 md8>
                                <b-form-checkbox id="NonSktableEdit" v-model="editedItems[staticFields[10]]">
                                  NonStkable ?
                                </b-form-checkbox>
                              </v-flex>
                              <v-flex xs12 sm4 md4>
                                <b-form-checkbox id="inActive" v-model="editedItems[staticFields[11]]">
                                  inActive ?
                                </b-form-checkbox>
                              </v-flex>
                              <v-flex xs12 sm8 md8>
                                <b-form-checkbox id="Authorised" v-model="editedItems[staticFields[12]]">
                                  is Authorized ?
                                </b-form-checkbox>
                              </v-flex>
                            </v-layout>
      ...
      <v-dialog v-model="addItemMasterModel" fullscreen hide-overlay transition="dialog-bottom-transition">
        <v-card>
          <v-toolbar fixed dark color="primary">
            <v-btn icon dark @click="loadItemMaster()">
              <v-icon>close</v-icon>
            </v-btn>
            <v-toolbar-title>{{ $store.state.pageName }} - Add</v-toolbar-title>
            <v-spacer></v-spacer>
            <v-btn class="blue darken-1 white--text" @click="loadItemMaster()">List</v-btn>
                        ...
                        <v-card-text>
                          ...
                          <v-container fluid grid-list-xl>
                            <v-layout row justify-space-between>
                              ...
                              <v-flex xs12 sm6 md4>
                                <label for="">{{ `Tally Alias:` }}</label>
                                <b-form-input id="code" v-model="addItems[staticFields[4]]" type="text"
                                  :placeholder="`Tally Alias`" />
                              </v-flex>
                              <v-flex xs12 sm6 md4>
                                <label for="">{{ `HSN Code:` }}</label>
                              ...
                              <v-flex xs12 sm6 md4>
                                ...
                                <b-form-input name="ItemTypeListAdd" v-model="addItems[staticFields[6]]" type="text"
                                  :placeholder="`Item Type`" list="ItemTypeListAdd"
                                  v-bind:class="{ 'form-control': true, 'is-invalid': !validAdditemType() && itemTypeBlured }"
                                  v-on:blur="itemTypeBlured = true" aria-describedby="itemTypeLiveFeedback" />
                                <datalist id="ItemTypeListAdd">
                                  <option v-for="data in itemTypeList" :key="data.id" :value="data.itemTypeName">
                                    {{ data.itemTypeName }}</option>
                                </datalist>
                                <b-form-invalid-feedback id="itemTypeLiveFeedback">
                                  This field is required
                                </b-form-invalid-feedback>
                              ...
                              <v-layout wrap>
                                <v-flex xs12 sm4 md4>
                                  <b-form-checkbox id="BOMItem" v-model="addItems[staticFields[8]]">
                                    BOM Item ?
                                  </b-form-checkbox>
                                </v-flex>
                                <v-flex xs12 sm8 md8>
                                  <b-form-checkbox id="NonSktable" v-model="addItems[staticFields[9]]">
                                    NonStkable ?
                                  </b-form-checkbox>
                                </v-flex>
                                <!-- <v-flex xs12 sm4 md4>
