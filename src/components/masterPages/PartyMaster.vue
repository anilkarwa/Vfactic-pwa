  ...
  <div id="app">
    <v-app id="inspire">
      ...
      <div class="text-md-center text-lg-center">
        <v-btn fab dark color="indigo" @click="addItemInPartyMaster" v-if="getCurrentUserRoles('addRight') == '1'">
            ...
            <tr>
              <td class="justify-center layout px-0">
                <v-icon v-if="getCurrentUserRoles('editRight') == '1'" small class="mr-2"
                  @click="editPartyMasterData(props.item)">edit</v-icon>
                        ...
                        <v-container fluid grid-list-xl>
                          <v-layout row justify-space-between>
                            ...
                            <v-flex xs12 sm6 md4>
                              ...
                              <b-form-input id="code" v-model="editItems[staticFields[11]]" type="text"
                            ...
                            <v-flex xs12 sm6 md4>
                              <b-form-checkbox id="checkbox1" v-model="editItems[staticFields[14]]">
                                in Active ?
                              </b-form-checkbox>
                            </v-flex>
                            <v-flex xs12 sm6 md4>
                              <b-form-checkbox id="checkbox2" v-model="editItems[staticFields[15]]">
                                is Authorised ?
                                <br /><br />
                              </b-form-checkbox>
                            </v-flex>
