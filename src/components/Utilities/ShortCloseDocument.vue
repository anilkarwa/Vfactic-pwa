      ...
      <v-card-title> 
       ...
       <v-container fluid grid-list-xl>
        ...
        <v-flex xs12 sm6 d-flex>
           <v-select v-model="selectedDocument" :items="documentList" item-text="docName" item-value="docId" label="Document"  solo  ></v-select>
        </v-flex>
         <v-flex xs12 sm6 d-flex>
          ...
          <v-card-title> 
            ...
            <v-btn color="error" v-if="selected.length >0"  class="white--text" @click="shortCloseSelecteRowData()" >
              ...
              <v-icon right dark>cancel</v-icon>
                ...
                <v-data-table v-model="selected" :headers="shortCloseTableHeader" :item-key="prefix+'DTLID'" :items="shortCloseTableData"
                 select-all class="elevation-1" hide-actions>
